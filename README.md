...
Physical Review D DOI: https://doi.org/10.1103/PhysRevD.111.083056
...
### The investigated relations for key global, EoS-independent parameterizations of the neutron star's surface, are defined by the following analytical expressions:
| $R_{\mathrm{pole}}/R_{\mathrm{eq}}$: $\mathcal{R(C,\sigma)}$| Star's eccentricity: $e(C,\sigma)$| Max of Logaritmic derivative: $\left(\frac{d \log R(\mu)}{d\theta}\right)_{\mathrm{max}}$|
|:--------:|:---------------------------:|:-------------:|
...
```
@article{papigkiotis2025universal,
  title={Universal description of a neutron star’s surface and its key global properties: A machine learning approach for nonrotating and rapidly rotating stellar models},
  author={Papigkiotis, Grigorios and Vardakas, Georgios and Likas, Aristidis and Stergioulas, Nikolaos},
  ...
  year={2025},
  publisher={APS},
  url={https://journals.aps.org/prd/abstract/10.1103/PhysRevD.111.083056}
}
```
